...
public static void main(String[] args) throws Exception {
    ...
    for(int i = 0; i<tsükli_pikkus;i++) { 
	   ...
	   System.out.print(""); 	 
	   String vastus = scan.nextLine().toLowerCase(); // teen tÃ¤hed vÃ¤ikseks
